...
<head>
    ...
    <title>Laundry-O | Panel Admin</title>
...
<body>
    ...
    <div class="page-container">
                              ...
                              <?php } else if($this->session->userdata('id_level') == 2) {?>
                                <li class="">
                                    <a href="<?php echo base_url();?>index.php/dashboard" aria-expanded="true"><i class="ti-dashboard"></i><span>Dashboard</span></a>
                                      ...
                                      <li>
                                      <a href="javascript:void(0)" aria-expanded="true"><i class="fa fa-table"></i><span> Data Order</span></a>
                                        <ul class="collapse">
              ...
              <div class="row align-items-center">
                  ...
                  <div class="col-sm-6 clearfix">
                      <div class="user-profile pull-right">
                        <?php if($this->session->userdata('id_level') == 1) {?>
                          <img class="avatar user-thumb" src="<?php echo base_url();?>assetsd/assets/images/author/avatar.png" alt="avatar">
                        <?php } else if($this->session->userdata('id_level') == 2) {?>
                              <img class="avatar user-thumb" src="<?php echo base_url();?>assetsd/assets/images/icon/motorcycle.png" alt="avatar">
                            <?php } else if($this->session->userdata('id_level') == 3) {?>
                                  <img class="avatar user-thumb" src="<?php echo base_url();?>assetsd/assets/images/icon/customer-service.png" alt="avatar">
                            <?php } ?>
        ...
        <footer>
            <div class="footer-area">
                <p>© Copyright 2019. All right reserved. by Moklet </p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
    ...
    <script src="<?php echo base_url();?>assetsd/assets/js/line-chart.js"></script>
    <!-- all pie chart -->
    <script src="<?php echo base_url();?>assetsd/assets/js/pie-chart.js"></script>
    <!-- others plugins -->
